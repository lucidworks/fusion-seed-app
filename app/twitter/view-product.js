...
angular.module('fusionSeed.viewTwitterProduct', ['ngRoute','solr.Directives', 'twitter.Directives', 'fusion.Directives'])
    ...
    .controller('ViewTwitterCtrl', function ($scope, $http, $routeParams, $location, $route, $sce, fusionHttp, ecommService) {
